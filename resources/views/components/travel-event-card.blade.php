...
@if ($event)
    ...
    @if(!!$can_edit)
        ...
        <x-modal name="update-event-header-{{ $event->id }}" focusable>
            <form method="post" action="{{ route('travel-events.update-header', ['redirect_to' => $redirect_to, 'query_parameters' => $query_parameters]) }}" class="p-6" enctype="multipart/form-data">
                @csrf
                @method('patch')
        ...
        <x-modal name="update-event-price-{{ $event->id }}" focusable>
            <form method="post" action="{{ route('travel-events.update-price', ['redirect_to' => $redirect_to, 'query_parameters' => $query_parameters]) }}" class="p-6" enctype="multipart/form-data">
                @csrf
                @method('patch')
        ...
        <x-modal name="update-event-description-{{ $event->id }}" focusable>
            <form method="post" action="{{ route('travel-events.update-description', ['redirect_to' => $redirect_to, 'query_parameters' => $query_parameters]) }}" class="p-6" enctype="multipart/form-data">
                @csrf
                @method('patch')
